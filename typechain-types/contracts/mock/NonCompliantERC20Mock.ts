...
export interface NonCompliantERC20MockInterface extends utils.Interface {
  functions: {
...
export interface NonCompliantERC20Mock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NonCompliantERC20MockInterface;
