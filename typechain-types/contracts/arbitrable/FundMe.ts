...
export declare namespace FundMe {
  ...
  export type TransactionStruct = {
    ...
    milestones: FundMe.MilestoneStruct[];
  ...
  export type TransactionStructOutput = [
    string,
    BigNumber,
    FundMe.MilestoneStructOutput[],
    string,
    string
  ] & {
    receiver: string;
    totalFunded: BigNumber;
    milestones: FundMe.MilestoneStructOutput[];
    erc20: string;
    voteToken: string;
  };
}
...
export interface FundMeInterface extends utils.Interface {
  functions: {
    ...
    "createTransaction(uint8[],address,string)": FunctionFragment;
  ...
  events: {
    ...
    "TransactionCreated(uint256,address)": EventFragment;
  };
...
export interface FundMe extends BaseContract {
  ...
  functions: {
    ...
    getTransaction(
      ...
      [FundMe.TransactionStructOutput] & {
        _transaction: FundMe.TransactionStructOutput;
      }
    >;
    ...
    getTransactionMilestone(
      ...
      [FundMe.MilestoneStructOutput] & {
        _milestone: FundMe.MilestoneStructOutput;
      }
    >;
  ...
  getTransaction(
    transactionId: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides
  ): Promise<FundMe.TransactionStructOutput>;

  getTransactionMilestone(
    transactionId: PromiseOrValue<BigNumberish>,
    milestoneId: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides
  ): Promise<FundMe.MilestoneStructOutput>;
  ...
  filters: {
    ...
    "TransactionCreated(uint256,address)"(
      _transactionID?: null,
